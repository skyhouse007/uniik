...
function Pill({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center gap-2 rounded-2xl border border-white/15 bg-black/40 px-3 py-2 text-xs font-semibold text-[rgb(var(--fg))] shadow-sm">
      {children}
    </span>
  )
}
